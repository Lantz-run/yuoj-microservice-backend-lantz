...
public interface UserService extends IService<User> {
     ...
     * @return 新用户 id
     */
    long userRegister(String userAccount, String userPassword, String userName, String checkPassword, String userEmail);
     ...
     * @return 脱敏后的用户信息
     */
    LoginUserVO userLogin(String userAccount, String userPassword, HttpServletRequest request, String userEmail);
